...
function SpaceshipPage() {
  ...
  useEffect(() => {
    ...
    if (playing) {
      // Top LOD: SSE=1 ≈ render at the finest tile that fits a pixel.
      apply(rt, 1, 2 * 1024 * 1024 * 1024); // 2 GiB cache for photoreal
      apply(ot, 1, 1024 * 1024 * 1024);     // 1 GiB cache for OSM
