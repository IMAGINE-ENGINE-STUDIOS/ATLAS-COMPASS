          ...
          >
            <div className="flex items-start justify-between gap-1.5">
              <div className="flex items-center gap-2.5">
                <Link to="/">
                  <GlassPanel className="p-1.5.5 cursor-pointer hover:bg-black/75 transition-colors">
                    <ArrowLeft className="w-4 h-4 text-white/70" />
                  </GlassPanel>
                </Link>
                <GlassPanel className="hidden sm:flex px-3 py-1.5.5 items-center gap-1.5">
                ...
                <GlassPanel className="p-3">
                  ...
                  <div className="relative mb-2.5">
                    ...
                    <input
                      ...
                      className="w-full bg-black/70 border border-white/[0.08] rounded-lg px-3 py-1.5.5 text-sm text-white outline-none focus:border-blue-400/40 placeholder:text-white/85 transition-colors"
                    />
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 px-3 py-1.5.5 bg-blue-500/20 border border-blue-500/30 rounded-lg text-sm font-medium text-blue-400 hover:bg-blue-500/30 transition-colors disabled:opacity-30 disabled:cursor-not-allowed mb-2.5"
                  >
                    {routeLoading ? (
                  ...
                  {routeInfo && !journeyActive && (
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-1.5 px-3 py-1.5.5 bg-green-500/20 border border-green-500/30 rounded-lg text-sm font-medium text-green-400 hover:bg-green-500/30 transition-colors mb-2.5"
                    >
                  ...
                  {(routeInfo || originPoint || destPoint) && (
                    ...
                    >
                      <Trash2 className="w-2.5.5 h-2.5.5" /> Clear Route
                    </button>
                  )}
                </GlassPanel>
              </div>
              ...
              >
                <GlassPanel className={isMobile ? "max-h-[calc(100dvh-9rem)] overflow-y-auto p-3" : "p-4"}>
                  ...
                  <input
                    ...
                    className="w-full bg-black/70 border border-white/[0.08] rounded-lg px-3 py-1.5.5 text-sm text-white outline-none focus:border-yellow-400/40 placeholder:text-white/85 transition-colors mb-2.5"
                  />
                  <textarea
                    value={poiDescription} onChange={(e) => setPoiDescription(e.target.value)}
                    placeholder="Description (optional)..." rows={3}
                    className="w-full bg-black/70 border border-white/[0.08] rounded-lg px-3 py-1.5.5 text-sm text-white outline-none focus:border-yellow-400/40 placeholder:text-white/85 transition-colors resize-none"
                  />
              ...
              >
                <GlassPanel className="p-4">
                  ...
                  <input
                    ...
                    className="w-full bg-black/70 border border-white/[0.08] rounded-lg px-3 py-1.5.5 text-sm text-white outline-none focus:border-emerald-400/40 placeholder:text-white/85 transition-colors mb-2.5"
                  />
                  ...
                  {placedModels.length === 0 ? (
                    ...
                    <div className="max-h-56 overflow-y-auto space-y-1">
                      {placedModels.map((model) => (
                        <div key={model.id} className="flex items-center gap-2.5 px-2.5 py-1.5.5 rounded-lg hover:bg-black/70 group transition-colors">
                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all">
                            <button
                              ...
                              title="Fly to"
                            >
                              <Move className="w-2.5.5 h-2.5.5" />
                            </button>
                            <button
                              ...
                              title="Delete"
                            >
                              <Trash2 className="w-2.5.5 h-2.5.5" />
                            </button>
                          </div>
                        </div>
                      ))}
                ...
                <GlassPanel className="p-4">
                  ...
                  <div className="flex gap-1.5">
                    <button onClick={() => flyToPOI(selectedPOI)}
                      ...
                      <Navigation className="w-2.5.5 h-2.5.5" /> Fly To
                    </button>
                ...
                <div className="relative">
                  ...
                  {(() => {
                    ...
                    return (
                      ...
                      >
                        <Star className={`w-2.5.5 h-2.5.5 ${sel ? "fill-[#1a1300] text-[#1a1300]" : "text-white/80"}`} />
                      </button>
                    );
                  })()}
                  <POICard
                ...
                <GlassPanel className="p-3">
                  ...
                  {pois.length === 0 ? (
                    ...
                    <div className="max-h-64 overflow-y-auto space-y-1">
                      {pois.map((poi) => (
                        <div key={poi.id} className="flex items-center gap-2.5 px-2.5 py-1.5.5 rounded-lg hover:bg-black/70 group transition-colors">
                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all">
                            <button onClick={() => flyToPOI(poi)}
                              ...
                              <Navigation className="w-2.5.5 h-2.5.5" />
                            </button>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-end justify-between gap-1.5">
              <GlassPanel className="px-2.5 py-1.5 sm:px-3 sm:py-2.5 flex-1 min-w-0">
                <div className="flex items-center gap-1.5 sm:gap-3">
                  <img src={targetPng} alt="Target" width={16} height={16} className="w-2.5.5 h-2.5.5 object-contain shrink-0" />
                  {cursorInfo ? (
                  ...
                  <div className="relative flex items-center gap-1 cursor-text flex-1 min-w-0"
                    ...
                    <Search className="w-2.5.5 h-2.5.5 sm:w-3.5 sm:h-3.5 text-primary shrink-0" />
                    {searchOpen ? (
                    ...
                    {searchOpen && (
                      <button onClick={(e) => { e.stopPropagation(); setSearchOpen(false); }} className="shrink-0"><X className="w-2.5.5 h-2.5.5 text-white/75" /></button>
                    )}
              ...
              <GlassPanel className="px-2.5 py-1.5 sm:px-3 sm:py-2.5 shrink-0">
                <div className="flex items-center gap-1.5 sm:gap-2.5">
                  <img src={eyePng} alt="Eye" width={16} height={16} className="w-2.5.5 h-2.5.5 sm:w-3.5 sm:h-3.5 object-contain shrink-0" />
                  <div>
                    <p className="text-[8px] sm:text-[9px] text-white/70 uppercase tracking-wider">Alt</p>
