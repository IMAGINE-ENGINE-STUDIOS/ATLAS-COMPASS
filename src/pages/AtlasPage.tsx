        ...
        <div className="max-w-7xl mx-auto px-3 py-2.5 flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className="relative">
              ...
              >
                <Radius className="w-2.5.5 h-2.5.5 text-primary" />
                {radiusKm}km
        ...
        <div className="max-w-7xl mx-auto px-3 pb-2.5">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/[0.08] rounded-lg pl-9 pr-9 py-1.5.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-primary/40 transition-colors"
            />
            {searchQuery && (
          ...
          <div className="grid gap-1.5">
            {filtered.map(b => (
              <motion.div
                ...
                className={`group bg-white/[0.03] border rounded-xl p-2.5.5 cursor-pointer transition-all hover:bg-white/[0.06] ${
                  ...
                  {selectedBusiness?.id === b.id && (
                    ...
                    >
                      <div className="flex gap-1.5 mt-2.5 pt-2.5 border-t border-white/[0.06]">
                        ...
                        >
                          <MapPin className="w-2.5.5 h-2.5.5" />
                          Google Maps
                        </Button>
                      </div>
