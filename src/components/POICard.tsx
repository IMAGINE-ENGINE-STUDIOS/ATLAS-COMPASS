  ...
  if (compact) {
    ...
    return (
      <button
        ...
        className={`w-full flex items-center gap-1.5.5 px-2.5 py-1.5.5 rounded-lg text-left transition-all group min-h-[37.4px] ${
          isGlass
      ...
      >
        ...
        <Navigation className={`w-2.5.5 h-2.5.5 shrink-0 transition-colors ${
      ...
      <div className="p-2.5.5">
        ...
        <div className="grid grid-cols-2 gap-1 mt-2.5">
          {onNavigate && (
            ...
            >
              <Navigation className="w-2.5.5 h-2.5.5 shrink-0" /> Navigate
            </button>
          )}
          {onDirections && (
            <button
          ...
          {poi.address && (onDelivery || navigate) && (
            ...
            >
              <Truck className="w-2.5.5 h-2.5.5 shrink-0" /> Delivery
            </button>
          )}
          {onSelect && (
            <button
            ...
            >
              <MapPin className="w-2.5.5 h-2.5.5 shrink-0" /> Details
            </button>
          )}
        </div>
      </div>
