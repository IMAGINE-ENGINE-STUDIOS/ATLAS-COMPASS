      ...
      <div className="rounded-xl bg-black/85 backdrop-blur-2xl border border-white/[0.1] shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 border-t border-white/[0.06] bg-black/40">
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-white/[0.06] text-white/80 border border-white/[0.08] hover:bg-white/[0.12] hover:text-white transition"
          ...
          {!active && (
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-red-500/15 text-red-300 border border-red-500/30 hover:bg-red-500/25 transition"
          ...
          {active?.state === "recording" && (
            <>
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-amber-500/15 text-amber-300 border border-amber-500/30 hover:bg-amber-500/25 transition"
                title="Pause"
              >
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-red-500/30 text-red-200 border border-red-500/50 hover:bg-red-500/40 transition"
                title="Stop & save"
              >
          ...
          {active?.state === "paused" && (
            <>
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 hover:bg-emerald-500/25 transition"
                title="Resume"
              >
          ...
          {onOpenGallery && (
            <button
              onClick={onOpenGallery}
              className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider text-white/60 hover:text-white transition"
